  ...
  <table>
    <tr>
      <th>
        ...
        <br/>
        <form:input path="firstName" size="30" maxlength="80" style='border: solid 1pt;'/>
      </th>
    </tr>
    <tr>
      <th>
        ...
        <br/>
        <form:input path="lastName" size="30" maxlength="80" style='border: solid 1pt;'/>
      </th>
    </tr>
    <tr>
      <th>
        ...
        <br/>
        <form:input path="address" size="30" maxlength="80" style='border: solid 1pt;'/>
      </th>
    </tr>
    <tr>
      <th>
        ...
        <br/>
        <form:input path="city" size="30" maxlength="80" style='border: solid 1pt;'/>
      </th>
    </tr>
    <tr>
      <th>
        ...
        <br/>
        <form:input path="telephone" size="20" maxlength="20" style='border: solid 1pt;'/>
      </th>
    </tr>
    <tr>
      <td>
